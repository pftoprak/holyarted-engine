...
const content = {
  en: {
    ...
    note: 'A reflective framework calculated from your details—not a diagnosis or prediction.',
  },
  tr: {
    ...
    note: 'Bilgilerinden hesaplanan bir düşünme çerçevesidir; tanı veya öngörü değildir.',
  },
} as const;
...
const styles = StyleSheet.create({
  ...
  ambientOrb: { position: 'absolute', width: 360, height: 360, borderRadius: 180, borderWidth: 1, borderColor: gold, backgroundColor: 'rgba(201,154,103,.1)', top: 90, right: -210 }, ambientOrbResult: { position: 'absolute', width: 420, height: 420, borderRadius: 210, borderWidth: 1, borderColor: ink, top: 80, right: -250 },
  ...
  calculationPage: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 28, overflow: 'hidden' }, calcMonogram: { width: 82, height: 82, borderWidth: 1, borderColor: 'rgba(213,166,111,.38)', alignItems: 'center', justifyContent: 'center' }, calcMonogramText: { color: gold, fontFamily: display, fontSize: 38 }, calcTitle: { color: ivory, fontFamily: display, fontSize: 40, lineHeight: 44, textAlign: 'center', marginTop: 30 }, calcCopy: { color: 'rgba(243,239,231,.42)', fontSize: 13, lineHeight: 20, textAlign: 'center', marginTop: 12 }, calcTrack: { height: 1, width: '100%', backgroundColor: 'rgba(255,255,255,.1)', marginTop: 38, overflow: 'hidden' }, calcFill: { height: 1, width: '100%', backgroundColor: gold, transformOrigin: 'left' },
  resultLabel: { color: 'rgba(17,20,17,.6)', fontSize: 9, fontWeight: '800', letterSpacing: 2, marginTop: 44, paddingHorizontal: 20 }, resultTitle: { color: ink, fontFamily: display, fontSize: 58, lineHeight: 55, letterSpacing: -2, paddingHorizontal: 20, marginTop: 16 }, resultIntro: { color: 'rgba(17,20,17,.68)', fontSize: 15, lineHeight: 24, paddingHorizontal: 20, marginTop: 22 }, resultGrid: { marginTop: 36, borderTopWidth: 1, borderTopColor: 'rgba(17,20,17,.2)' }, resultCard: { minHeight: 210, borderBottomWidth: 1, borderBottomColor: 'rgba(17,20,17,.2)', padding: 22, overflow: 'hidden' }, cardIndex: { color: 'rgba(17,20,17,.54)', fontSize: 9, fontWeight: '800', letterSpacing: 1.3 }, cardTitle: { color: ink, fontFamily: display, fontSize: 31, lineHeight: 34, marginTop: 30 }, cardBody: { color: 'rgba(17,20,17,.66)', fontSize: 13, lineHeight: 21, marginTop: 12 }, sourceBody: { color: 'rgba(17,20,17,.5)', fontSize: 11, lineHeight: 19, marginTop: 16, borderTopWidth: 1, borderTopColor: 'rgba(17,20,17,.14)', paddingTop: 14 }, cardAccent: { position: 'absolute', width: 90, height: 1, backgroundColor: ink, right: 0, bottom: 0 }, darkButton: { backgroundColor: ink, marginHorizontal: 20, marginTop: 30, minHeight: 50, alignItems: 'center', justifyContent: 'center' }, darkButtonText: { color: ivory, fontSize: 11, fontWeight: '800' },
});
