...
export function ProfileClient({ authConfig }: { authConfig: PublicAuthConfig | null }) {
  ...
  const { user, membership, ready, pending, error, signInWithGoogle, signOut, openBillingPortal, refreshMembership } = useHolyartedAccount(authConfig);
